...
export const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div className="group rounded-xl border border-amber-900/20 bg-slate-900/50 hover:bg-slate-900/80 transition overflow-hidden flex flex-col h-full">
      ...
      <div className="flex flex-col flex-1 p-4">
        ...
        <h3 className="font-semibold text-amber-50 text-sm mb-2 line-clamp-2">{product.name}</h3>
        ...
        <div className="mt-auto space-y-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="w-16 px-2 py-2 bg-slate-800 border border-amber-900/30 rounded text-amber-50 text-sm"
            />
            <button
